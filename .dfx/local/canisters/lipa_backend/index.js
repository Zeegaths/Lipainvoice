...
import { idlFactory } from './lipa_backend.did.js';
export { idlFactory } from './lipa_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LIPA_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./lipa_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the lipa_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./lipa_backend.did.js")._SERVICE>}
 */
export const lipa_backend = createActor(canisterId);
