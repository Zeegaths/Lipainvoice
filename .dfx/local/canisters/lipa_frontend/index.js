...
import { idlFactory } from './lipa_frontend.did.js';
export { idlFactory } from './lipa_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LIPA_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./lipa_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the lipa_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./lipa_frontend.did.js")._SERVICE>}
 */
export const lipa_frontend = createActor(canisterId);
