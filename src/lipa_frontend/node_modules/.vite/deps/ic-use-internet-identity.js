...
function createStoreCore(initialContext2, transitions, updater) {
  ...
  function receive(event) {
    ...
    (_a = inspectionObservers.get(store2)) == null ? void 0 : _a.forEach((observer) => {
      var _a2;
    ...
    observers == null ? void 0 : observers.forEach((o) => {
      var _a2;
      return (_a2 = o.next) == null ? void 0 : _a2.call(o, currentSnapshot);
    });
  ...
  const store2 = {
    ...
    subscribe(observerOrFn) {
      ...
      observers ?? (observers = /* @__PURE__ */ new Set());
      observers.add(observer);
      return {
        unsubscribe() {
          return observers == null ? void 0 : observers.delete(observer);
        }
      };
    },
    [symbolObservable]() {
    ...
    inspect: (observerOrFn) => {
      ...
      (_b = observer.next) == null ? void 0 : _b.call(observer, {
        type: "@xstate.snapshot",
      ...
      return {
        unsubscribe() {
          var _a2;
          return (_a2 = inspectionObservers.get(store2)) == null ? void 0 : _a2.delete(observer);
        }
      };
    }
  };
...
function createStoreTransition(transitions, updater) {
  return (snapshot, event) => {
    ...
    if (typeof assigner === "function") {
      currentContext = updater ? updater(currentContext, (draftContext) => assigner == null ? void 0 : assigner(draftContext, event, enqueue)) : setter(currentContext, (draftContext) => Object.assign({}, currentContext, assigner == null ? void 0 : assigner(
        draftContext,
        event,
        // TODO: help me
        enqueue
...
function useSelector(store2, selector, compare = defaultCompare) {
  ...
  return (0, import_react.useSyncExternalStore)((0, import_react.useCallback)((handleStoreChange) => store2.subscribe(handleStoreChange).unsubscribe, [store2]), () => selectorWithCompare(store2.getSnapshot()), () => selectorWithCompare(store2.getInitialSnapshot()));
}
var initialContext = {
...
function login() {
  ...
  if (!identity.getPrincipal().isAnonymous() && isDelegationValid(identity.getDelegation())) {
...
function onLoginSuccess() {
  var _a;
  const identity = (_a = store.getSnapshot().context.authClient) == null ? void 0 : _a.getIdentity();
  if (!identity) {
...
//# sourceMappingURL=ic-use-internet-identity.js.map
